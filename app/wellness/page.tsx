  ...
  return (
    <div className="min-h-screen bg-[#fffaeb] font-pixel">
      ...
      <main className="container mx-auto p-4 md:p-8">
        <h1 className="text-3xl md:text-4xl mb-6 text-center text-[#33272a]">MENTAL WELLNESS CENTER</h1>
        <p className="text-center text-[#594a4e] mb-4">Research-backed tools to improve your mental wellbeing and build resilience.</p>
      ...
      <footer className="bg-[#33272a] text-white p-4 text-center text-xs mt-12">
        ...
        <p className="mt-2">TAKE CARE OF YOUR MIND</p>
      </footer>
    </div>
  )
}
